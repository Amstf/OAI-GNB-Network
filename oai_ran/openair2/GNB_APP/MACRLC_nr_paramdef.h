...
#define MACRLCPARAMS_DESC { \
  ...
  {CONFIG_STRING_MACRLC_PUCCH_RSSI_THRESHOLD,        HLP_MACRLC_PUCCH_RSSI_THRESHOLD, \
                                                                               0, .iptr=NULL,   .defintval=0,               TYPE_INT,     0}, \
  {CONFIG_STRING_MACRLC_SLICE_CONF,                  NULL,                     0, .strptr=NULL, .defstrval=NULL,            TYPE_STRING,  0}, \
}
// clang-format off
...
#define MACRLC_SLICE_CONF_IDX                                  42
...
enum {
  MACRLCPARAMS_DESC_SIZE = sizeof((paramdef_t [])MACRLCPARAMS_DESC) / sizeof(paramdef_t),
  MACRLCPARAMS_CHECK_SIZE = sizeof((checkedparam_t [])MACRLCPARAMS_CHECK) / sizeof(checkedparam_t)
};

_Static_assert(MACRLCPARAMS_DESC_SIZE == MACRLCPARAMS_CHECK_SIZE,
               "MACRLC param definition and check arrays must stay aligned");
